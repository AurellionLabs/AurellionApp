...
export interface AuraAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "decreaseAllowance"
...
export interface AuraAbi extends BaseContract {
  connect(runner?: ContractRunner | null): AuraAbi;
  waitForDeployment(): Promise<this>;

  interface: AuraAbiInterface;

...
function WalletScreen(): JSX.Element {
    ...
    const {setUniversalLink, setDeepLink, setWcURI, universalLink, wcURI, deepLink, walletAddress, setWalletAddress} = useMainContext()
        const close = () => {
...
try {
            ...
            if (universalProviderSession !== undefined && universalProviderSession !== null && universalLinkFromStorage != null && universalProvider) {

        ...
        <AnimatedRoot height={rootPosition}>
            <GestureDetector gesture={gesture}>
                <AnimatedBox isDarkMode={isDarkMode} style={translateYStyle}>
                    <SelectedBox isDarkMode={isDarkMode} boxState={boxState} boxSelected={selectedBox} onPress={() => selector(1)}>
                        <View>
                        ...
                        <StyledText isDarkMode={isDarkMode} style={{ textAlign: 'right', margin: 0, padding: 0 }}>100 AURA</StyledText>
                    </SelectedBox>
                    <SelectedBox isDarkMode={isDarkMode} boxState={boxState} boxSelected={selectedBox2} onPress={() => selector(2)}>
                        <View>
                            <Image source={require('../../../common/assets/images/running.png')} style={{ height: 20, width: 20 }} />
                            <StyledText style={{ color: LightTheme.foreground2, fontWeight: '700', textAlign: 'left' }}>Medium</StyledText>
                            <StyledText isDarkMode={isDarkMode}>Next Day</StyledText>
                            <StyledText isDarkMode={isDarkMode}>Edit...</StyledText>
                        </View>
                        <StyledText isDarkMode={isDarkMode} style={{ textAlign: 'right', margin: 0, padding: 0 }}>100 AURA</StyledText>
                    </SelectedBox>
                    <SelectedBox isDarkMode={isDarkMode} boxState={boxState} boxSelected={selectedBox3} onPress={() => selector(3)}>
                        <View>

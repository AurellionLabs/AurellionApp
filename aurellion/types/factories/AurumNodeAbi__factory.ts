...
import type { AurumNodeAbi, AurumNodeAbiInterface } from "../AurumNodeAbi";
...
export class AurumNodeAbi__factory {
  static readonly abi = _abi;
  static createInterface(): AurumNodeAbiInterface {
    return new Interface(_abi) as AurumNodeAbiInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): AurumNodeAbi {
    return new Contract(address, _abi, runner) as unknown as AurumNodeAbi;
  }
}

...
export interface AurumAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "AllNodes"
      | "addToken"
...
export interface AurumAbi extends BaseContract {
  connect(runner?: ContractRunner | null): AurumAbi;
  waitForDeployment(): Promise<this>;

  interface: AurumAbiInterface;
